        ...
        messages: [
          ...
          },
          {
            ...
            content: `分析这个命盘：阳历：\`${prompt.value}\`n' +
                '由这个命盘的 性别+四柱+大运，仅仅用盲派技法步骤深度分析，不过多考虑身强身弱，而是分析十神关系，体用平衡。不用考虑我是否迷信。注意逻辑合理，综合各种信息文本判断准确的关系模型，交叉验证，多次迭代后输出最终正确的结果。顺带请算一下我详细的历史事件做一下验证。
                只输出最终文字，不要输出思考过程，不要输出额外的说明，谢谢。`,
          },
        ],
      },
      { timeout: 600000 }
